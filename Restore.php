...
class Restore Extends Base\RestoreBase{
	...
	public function processLegacy($pdo, $data, $tables, $unknownTables) {
		...
		if($excludetrunks){
			...
			$this->restoreLegacyDatabase($pdo,[],['pjsip','sip','iax','trunks','outbound_route_patterns','outbound_route_sequence','outbound_route_trunks','outbound_routes','outbound_route_email','trunk_dialpatterns']);
		}else {
