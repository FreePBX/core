...
class gosubConfirm{
    static function add($ext){
        ...
        */
        ...
        $ext->add($context, $exten, '', new \ext_setvar('__GOSUB_RESULT','ABORT'));
        ...
        $ext->add($context, $exten, 'skip', new \ext_setvar('__GOSUB_RESULT',''));
        ...
        $exten = 'h';
        $ext->add($context, $exten, '', new \ext_gosub('1','s','hangupcall'));
    }
}
