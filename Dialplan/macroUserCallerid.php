...
class macroUserCallerid{
    ...
    */
	$ext->add($context, $exten, 'report', new \ext_noop('Macro depricated!! To keep the same line numbers'));
	$ext->add($context, $exten, '', new \ext_noop('Macro depricated !!  To keep the same line numbers'));
